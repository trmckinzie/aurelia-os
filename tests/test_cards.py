...
def test_generate_garden_card_html_contains_title_and_type():
    ...
    html = generate_garden_card_html(meta, "Some Concept.md", "note-some-concept", "body text")
...
def test_maturity_badge_shown_for_maturity_key():
    ...
    html = generate_garden_card_html(meta, "Some Concept.md", "note-some-concept", "body")
    assert "🌳" in html
...
def test_source_card_status_badge_reads_status_key():
    ...
    html = generate_garden_card_html(meta, "A Book.md", "note-a-book", "body")
...
"""
    ...
    html = generate_garden_card_html(meta, "A Notebook.md", "note-a-notebook", body)
...
"""
    html = generate_garden_card_html(meta, "A Deep Dive.md", "note-a-deep-dive", body, known_ids={"note-idea"})
...
def test_deep_dive_card_shows_no_links_placeholder_when_related_empty():
    ...
    body = "*A premise*\n\n## Part 3: Summary\n\nSome text.\n"
    html = generate_garden_card_html(meta, "N.md", "note-n", body)
...
def test_daily_log_card_carries_its_type_label():
    ...
    html = generate_garden_card_html({"tags": []}, "2026-03-07.md", "note-2026-03-07", "body")
...
def test_card_type_label_is_escaped():
    ...
    html = generate_garden_card_html({"type": "unknown-type", "tags": []}, "A.md", "note-a", "b")
