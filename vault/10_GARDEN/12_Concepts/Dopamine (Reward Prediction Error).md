...
**🔗 Related:** [[Evolutionary Mismatch]], [[The Prefrontal Cortex (PFC)]], [[System 1 vs System 2 (Dual-Process Theory)]], [[Allostatic Load]], [[Robert Sapolsky]], [[Working Memory]]

---

### 💡 Definition
> A neurotransmitter heavily concentrated in the brain's reward circuitry (the ventral tegmental area and nucleus accumbens) that drives motivation, craving, and goal-directed behavior.

- **The Sapolsky Nuance:** Dopamine is not about the reward itself; it is about the _anticipation_ of the reward. The massive dopamine spike happens when you receive the _signal_ that a reward is coming, providing the metabolic energy required to do the work to get it.
    
- **Reward Prediction Error:** The brain is a prediction machine.
    
    - If a reward is _unexpected_, you get a massive dopamine spike (teaching you to pay attention to that trigger).
        
    - If a reward is _expected_ and received, dopamine remains at baseline (the behavior is maintained).
