...
### 💡 Definition
> A deeply interconnected network of brain structures—including the amygdala, hippocampus, hypothalamus, and basal ganglia—located roughly between the brainstem and the neocortex.

- **The Paleomammalian Brain:** In evolutionary terms, it is the middle layer of the brain. It evolved on top of the ancient "reptilian" brainstem (which handles pure reflex and autonomic breathing) and beneath the modern neocortex (which handles logic and language). It is the biological seat of emotion, motivation, and emotional memory.
...
- **The Mismatch:** It evolved to trigger in response to immediate physical threats or rewards. Today, it is constantly hijacked by abstract symbols—social media likes, news headlines, and stock market tickers—keeping the system in a state of chronic, low-grade exhaustion.
